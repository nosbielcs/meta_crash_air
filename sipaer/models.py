...
from sipaer.taxonomia import ClassificacaoTaxonomia, AeronaveTaxonomia, ComandoTaxonomia, FatorContribuicaoTaxonomia, SimNaoTaxonomia, DocumentoTaxonomia, StatusDocumentoTaxonomia, SituacaoTaxonomia
